        ...
        <VerticalTimeline lineColor=''>
            ...
            <React.Fragment key={index}>
                <VerticalTimelineElement
                    contentStyle={{
                        background: theme === 'light' ? '#f3f4f' : 'rgba(255, 255, 255, .05)',
                        boxShadow: 'none',
                    ...
                    contentArrowStyle={{
                        borderRight: theme === 'light' ? '0.4rem solid #9ca3f' : '0.4rem solid rgba(255, 255, 255, 0.5'
                    }}
                    date={exp.date}
                    icon={exp.icon}
                    iconStyle={{
                        background: theme ===  'light' ? 'white' : 'rgba(255, 255, 255, .5',
                        fontSize: '1.5rem',
                    }}
                >
