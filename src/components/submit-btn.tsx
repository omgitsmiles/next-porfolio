...
export default function SubmitBtn() {
  ...
  return (
    ...
    rounded-full outlne-none transition-all focus:scale-110 
    hover:scale-110 hover:bg-gray-950 active:scale-105 dark:bg-white dark:bg-opacity-10 disabled:scaled-100
